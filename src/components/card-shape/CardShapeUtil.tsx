...
import { resizeBox, type TLResizeInfo, type Editor } from 'tldraw'
...
function CardShapeComponent({ shape, editor }: { shape: TLCardShape; editor: Editor }) {
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {/* 非編輯：priority 圓點右上角 */}
                    {p.type !== 'heading' && !isSticky && !isEditing && p.priority && p.priority !== 'none' && PRIORITY_DOT[p.priority] && (
                        <div style={{
                            position: 'absolute',
